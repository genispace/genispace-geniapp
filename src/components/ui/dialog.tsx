...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      `fixed inset-0 ${Z_INDEX_CLASSES.MODAL_BACKDROP} bg-black/50 dark:bg-black/70 backdrop-blur-sm data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0`,
      className
    )}
    {...props}
  />
...
>(({ className, children, nested, onPointerDownOutside, onInteractOutside, ...props }, ref) => {
  const zIndexClass = nested ? Z_INDEX_CLASSES.NESTED_MODAL : Z_INDEX_CLASSES.MODAL_BACKDROP;
