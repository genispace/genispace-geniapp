...
import { formatCompactCurrency, formatCompactK, formatCurrencyK } from '../hero-card/heroCardUtils';
...
export interface SwCellProps {
  ...
  emptyDash?: boolean;
  /** Delta cells only: when the displayed (1-decimal) value is 0, render it without the leading '+'. */
