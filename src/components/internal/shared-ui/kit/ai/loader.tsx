/**
 * Kit/AI Loader — adapted from shadcn.io/ai `loader` (Vercel AI Elements
 * style). Spinning segmented indicator for streaming/thinking states.
 */
...
const LoaderIcon = ({ size = 16 }: LoaderIconProps) => (
  ...
  >
    <title>Loader</title>
    <g clipPath="url(#kit_ai_loader_clip)">
    ...
    <defs>
      <clipPath id="kit_ai_loader_clip">
