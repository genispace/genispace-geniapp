...
```typescript
import { Button, Input, Dialog } from '@genispace/shared-ui';
```

### Importing Primitives

```typescript
import { ArrayInput, JsonEditor } from '@genispace/shared-ui/primitives/forms';
import { EmptyState } from '@genispace/shared-ui/primitives/data-display';
```

### Importing Feature Components (Namespace Style)

```typescript
import { Task, Agent, Chat } from '@genispace/shared-ui/features';
...
```typescript
import { TaskInputForm } from '@genispace/shared-ui/features/task';
import { AgentCard } from '@genispace/shared-ui/features/agent';
```
