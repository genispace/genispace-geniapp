...
import { DialogSafeSelect as Select, DialogSafeSelectContent as SelectContent, DialogSafeSelectItem as SelectItem, DialogSafeSelectTrigger as SelectTrigger, DialogSafeSelectValue as SelectValue } from '@/components/ui/dialog-safe-select';
